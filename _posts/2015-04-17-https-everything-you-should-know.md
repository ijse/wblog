...
由于http是明文传输的，所以在互联风上传输隐私信息非常不安全，目前国外大多数网站都已经全面支持https, 但国内情况很差，不仅很少有大型网站全站支持https，甚至有些网站使用https不规范，安全协议过时，留下了一些安全隐患。<!--more-->
...
<blockquote>至于图片木马问题，可以通过在http response中添加header <code>X-Content-Type-Options: nosniff</code>解决。</blockquote>
